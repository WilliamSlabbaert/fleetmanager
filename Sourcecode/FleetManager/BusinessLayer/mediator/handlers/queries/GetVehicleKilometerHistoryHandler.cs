...
{
    public class GetVehicleKilometerHistoryHandler : IRequestHandler<GetVehicleKilometerHistoryQuery, GenericResult<GeneralModels>>
    {
        ...
        public Task<GenericResult<GeneralModels>> Handle(GetVehicleKilometerHistoryQuery request, CancellationToken cancellationToken)
        {
